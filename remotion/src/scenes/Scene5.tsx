...
export const Scene5 = () => {
  ...
  return (
    ...
    >
      <div style={{ transform: `translateY(${titleY}px)`, opacity: titleOpacity, textAlign: "center", marginBottom: 70 }}>
        <div
          style={{
            color: "#f0abfc",
            fontFamily: rajdhani,
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "44px 90px", maxWidth: 1300 }}>
        {benefits.map((benefit, i) => {
          const delay = 25 + i * 18;
          const itemSpring = spring({ frame: frame - delay, fps, config: { damping: 14, stiffness: 85 } });

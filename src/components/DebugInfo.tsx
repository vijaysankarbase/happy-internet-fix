...
const DebugInfo: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-14 left-0 right-0 z-50 bg-foreground/90 text-background px-3 py-1.5 flex items-center gap-4 text-[10px] font-mono backdrop-blur-sm">
      <span>
